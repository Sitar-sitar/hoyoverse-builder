...
Object.assign(CURATED, {
  ...
  "hsr:1507": { ...SOURCE.hsr, gameVersion: "4.4", sourceUrl: "https://game8.jp/houkaistarrail/776920", sourceLabel: t("StarRailRes の公式ゲームデータ（日本語・英語・中国語）と Game8 の2026-09-11更新ガイドを照合", "Cross-checked against official StarRailRes game data (JA/EN/ZH) and Game8's guide updated 2026-09-11", "已对照StarRailRes官方游戏数据（日/英/中）与Game8于2026-09-11更新的指南"), dataAsOf: "2026-09-11", updatedAt: "2026-09-11", effects: [
    effect(1, "死するまで、この身は成らず", "Eidolon 1", "星魂1", "結界が展開されている間、敵全体の全属性耐性-20%。天賦による追加の戦闘スキルを発動した後、「無量忿怒」のカウントダウンの行動順を15%遅延させる。", "While the Zone is active, decreases all enemies' All-Type RES by 20%. After using the extra Skill from Talent, the \"Infinite Fury\" countdown has its action delayed by 15%.", "结界持续期间，使敌方全体全属性抗性降低20%，施放天赋的额外战技后使【无量忿怒】倒计时行动延后15%。"),
    effect(2, "心は死灰の如く、されど炎は消えず", "Eidolon 2", "星魂2", "味方キャラが必殺技を発動してダメージを与える時、追加攻撃を行うと見なされる。味方の追加攻撃ダメージ+75%。千冶・刃のチャージ上限が7にダウンする。", "When an ally character uses Ultimate to deal DMG, it is considered as having launched Follow-Up ATK. And the Follow-Up ATK DMG dealt by ally targets increases by 75%. The upper limit of Mortenax Blade's Charge decreases to 7.", "我方角色施放终结技造成伤害时，被视为发动了追加攻击，我方目标造成的追加攻击伤害提高75%。千冶•刃充能点的上限降低至7。"),
    effect(3, "彼岸に渡り、忿怒の本相を現さん", "Eidolon 3", "星魂3", "必殺技のLv.+2、最大Lv.15まで。天賦のLv.+2、最大Lv.15まで。", "Ultimate Lv. +2, up to a maximum of Lv. 15. Talent Lv. +2, up to a maximum of Lv. 15.", "终结技等级+2，最多不超过15级；天赋等级+2，最多不超过15级。"),
    effect(4, "遺恨に鍛えられ、剣骨自ずと形を成す", "Eidolon 4", "星魂4", "「万淬の心」は味方の与ダメージをさらに50%アップさせる。", "\"Heart, Refined ad Infinitum\" additionally increases ally targets' DMG dealt by 50%.", "【万淬心】使我方目标造成的伤害额外提高50%。"),
    effect(5, "己が苦を断ち、死より生を知る", "Eidolon 5", "星魂5", "戦闘スキルのLv.+2、最大Lv.15まで。通常攻撃のLv.+1、最大Lv.10まで。", "Skill Lv. +2, up to a maximum of Lv. 15. Basic ATK Lv. +1, up to a maximum of Lv. 10.", "战技等级+2，最多不超过15级；普攻等级+1，最多不超过10级。"),
    effect(6, "神が殞落するならば、寿瘟を討つと誓わん", "Eidolon 6", "星魂6", "結界が展開されている間、千冶・刃がダメージを受ける、またはHPを消費した時、チャージを1獲得する。この効果はいずれかの味方または敵のターンが終了した後に再度発動可能になる。「千冶は一を鋳り、万劫を燼滅す」のダメージ倍率が元の倍率の150%になる。", "As the Zone persists, when Mortenax Blade takes DMG or consumes HP, he gains 1 Charge. This effect can trigger again after any target's turn ends. The DMG multiplier of \"Tenax Per Ignem\" increases to 150% of its original value.", "结界持续期间，千冶•刃受到伤害或消耗生命值时，获得1点充能，该效果在任意目标回合结束后可再次触发。【千冶铸一，万劫烬灭】的伤害倍率提高为原倍率的150%。"),
  ] },
  ...
  "hsr:1512": { ...SOURCE.hsr, gameVersion: "4.5", sourceUrl: "https://game8.jp/houkaistarrail/794388", sourceLabel: t("StarRailRes の公式ゲームデータ（日本語・英語・中国語）と Game8 の2026-09-11更新ガイドを照合", "Cross-checked against official StarRailRes game data (JA/EN/ZH) and Game8's guide updated 2026-09-11", "已对照StarRailRes官方游戏数据（日/英/中）与Game8于2026-09-11更新的指南"), dataAsOf: "2026-09-11", updatedAt: "2026-09-11", effects: [
    effect(1, "群れを離れた夏の鳥", "Eidolon 1", "星魂1", "「夏空フライト」は味方が与えた確定ダメージ以外のダメージの100%を記録する。精霊スキルを発動する時、残りHPが最も高い敵に追加でダメージ記録値（11%+現在のムード×0.1%）分の確定ダメージを与える。その後、記録値の50%をクリアする。", "\"Summer Songbirds\" will keep a tally of 100% of the non-True DMG dealt by ally targets. When using the Memosprite Skill, additionally deals True DMG to the enemy target with the highest HP, equal to (11% + current Vibes × 0.1%) of the total tally. Then, clears 50% of the tally.", "「晴空乐手」会记录我方目标造成的非真实伤害的100%，施放忆灵技时对生命值最高的敌方目标额外造成记录伤害总额（11%+当前气氛值点数*0.1%）的真实伤害，随后清空记录值的50%。"),
    effect(2, "その心は湖のよう", "Eidolon 2", "星魂2", "味方の全属性耐性貫通+18%。ロビン・夏空の歌のムード上限+20、味方が任意のユニットのターンで初めてスキルを発動してロビン・夏空の歌にムードを獲得させた時、ロビン・夏空の歌は追加でムードを2獲得する。", "Ally targets' All-Type RES PEN increases by 18%. The upper limit of Robin • Summeretto's Vibes increases by 20. The first time an ally target uses an ability during any target's turn to cause Robin • Summeretto to gain Vibes, she gains an additional 2 points.", "我方目标的全属性抗性穿透提高18%。知更鸟•晴歌的气氛值上限提高20点，我方目标在任意目标回合内第一次施放技能使知更鸟•晴歌获得气氛值时额外获得2点。"),
    effect(3, "道中の遺音を拾って", "Eidolon 3", "星魂3", "戦闘スキルのLv.+2、最大Lv.15まで。天賦のLv.+2、最大Lv.15まで。精霊天賦のLv.+1、最大Lv.10まで。", "Skill Lv. +2, up to a maximum of Lv. 15. Talent Lv. +2, up to a maximum of Lv. 15. Memosprite Talent Lv. +1, up to a maximum of Lv. 10.", "战技等级+2，最多不超过15级；天赋等级+2，最多不超过15级；忆灵天赋等级+1，最多不超过10级。"),
    effect(4, "衆弦の変奏を聴く", "Eidolon 4", "星魂4", "「フィーバー」状態に入る時、即座にムードを12獲得し、「夏空フライト」の速度+（20%+現在のムード×0.5%）。", "Upon entering the \"Fever\" state, immediately gains 12 Vibes, and increases the SPD of \"Summer Songbirds\" by an amount equal to (20% + current Vibes × 0.5%).", "进入【Fever】状态时，立即获得12点气氛值，「晴空乐手」的速度提高（20%+当前气氛值*0.5%）。"),
    effect(5, "また新たな朝日を追う", "Eidolon 5", "星魂5", "必殺技のLv.+2、最大Lv.15まで。通常攻撃のLv.+1、最大Lv.10まで。精霊スキルのLv.+1、最大Lv.10まで。", "Ultimate Lv. +2, up to a maximum of Lv. 15. Basic ATK Lv. +1, up to a maximum of Lv. 10. Memosprite Skill Lv. +1, up to a maximum of Lv. 10.", "终结技等级+2，最多不超过15级；普攻等级+1，最多不超过10级；忆灵技等级+1，最多不超过10级。"),
    effect(6, "名のない歌を歌おう", "Eidolon 6", "星魂6", "精霊スキルのダメージ倍率が元の倍率の100%アップする。「フィーバー」状態の時、ロビン・夏空の歌は必殺技を最大2回までストックできる。戦闘中、「フィーバー」状態に入った時、または「フィーバー」状態のカウントダウンのターンが回ってきた時、EPを固定で140回復する。", "Increases the Memosprite Skill's DMG multiplier by 100% of its original value. While in the \"Fever\" state, Robin • Summeretto can store her Ultimate up to 2 times. After entering the \"Fever\" state for the first time in this battle or when the the \"Fever\" countdown's turn starts, regenerates a fixed 140 Energy.", "忆灵技的伤害倍率提高原倍率的100%。处于【Fever】状态时，知更鸟•晴歌的终结技可以最多储存2次，本场战斗中第一次进入【Fever】状态后或【Fever】倒计时回合开始时，固定恢复140点能量。"),
  ] },
