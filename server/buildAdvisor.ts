...
Object.assign(GUIDE_OVERRIDES, {
  ...
  // 第20バッチ（2026-09-24）: Ver.4.5後半で実装。根拠は docs/batch-20-research-notes.md。
  "アベンチュリン・波と戯れる夏": { headline: "強化愉悦スキルで火力を出す量子の歓楽アタッカーとして、公開値の会心率100%と速度を最優先に整える。", relicSet: "功績輝く魔法少女 ×4", planarSet: "ステージゼロ：パンクロード ×2", mainStats: [{ slot: "胴体", value: "会心率" }, { slot: "脚部", value: "速度" }, { slot: "次元界オーブ", value: "量子属性ダメージ / HP%" }, { slot: "連結縄", value: "EP回復効率" }], targets: [{ key: "critRate", label: "会心率", unit: "%", targets: { "厳選": 100, "目標": 100, "妥協": 100 } }, { key: "speed", label: "速度", unit: "", targets: { "厳選": 168, "目標": 160, "妥協": 154 } }, { key: "critDmg", label: "会心ダメ", unit: "%", targets: { "厳選": 140, "目標": 130, "妥協": 110 } }], targetContext: "アベンチュリン・波と戯れる夏専用：会心率100%は Game8・GameWith（追加攻撃編成）の明示値。厳選の速度168・会心ダメージ140%は Game8（2026-09-24更新）のサブステータス目安、目標・妥協の速度160/154・会心ダメージ130/110%は GameWith（2026-09-22更新）の追加攻撃編成の理想/実用で、オーブを量子属性ダメージにした前提の値。愉悦キャリー編成の会心率90%は爻光の光円錐で会心率+10%される編成条件のため採用しない。必殺技の速度バフ（Game8 は「200以上」と記載）、熱気・爆笑ネタ・アッハタイム、遺物4セットの防御無視、光円錐・星魂・味方の効果は戦闘中または条件付きであり公開プロフィールへ加算しない。", dataAsOf: "2026-09-24", updatedAt: "2026-09-24", sourceLabel: "Game8・GameWithの更新日付き個別ビルド・StarRailResの公式星魂データを照合" },
});
