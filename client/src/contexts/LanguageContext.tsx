...
const copy = {
  ja: {
    ...
    comparisonPending: "最終ステータスを算出できないため、目標比較と強化提案を保留しています。数分後に再度お試しください。",
    enkaFinalStatsNote: "公開中のキャラクター・光円錐・遺物・解放済み軌跡から算出した戦闘外の最終値です。戦闘中・条件付き効果は含みません。",
    enkaStatsUnavailable: "静的データを取得できないため、最終ステータスの算出と目標比較を保留しています。数分後に再度お試しください。",
    mihomoFinalStatsNote: "公開中のキャラクター・光円錐・遺物・軌跡を合算した戦闘外の最終値です。戦闘中・条件付き効果は含みません。",
    mihomoStatsUnavailable: "最終ステータスを取得できないため、目標比較を保留しています。数分後に再度お試しください。",
    anySlot: "全部位", anySlotSubstatReason: "ガイドの主ステータスは別の役割で埋まっています。部位は問わないので、{stat}のサブステータスが付く装備を優先して厳選します。",
  ...
  en: {
    ...
    comparisonPending: "Final stats could not be calculated, so target comparisons and upgrade suggestions are on hold. Please try again in a few minutes.",
    enkaFinalStatsNote: "This is the out-of-combat final value calculated from the public character, light cone, relics, and unlocked trace nodes. In-combat and conditional effects are not included.",
    enkaStatsUnavailable: "Static data could not be retrieved, so calculating final stats and target comparisons is on hold. Please try again in a few minutes.",
    mihomoFinalStatsNote: "This is the out-of-combat final value combining the public character, light cone, relics, and trace nodes. In-combat and conditional effects are not included.",
    mihomoStatsUnavailable: "Final stats could not be retrieved, so target comparisons are on hold. Please try again in a few minutes.",
    anySlot: "Any slot", anySlotSubstatReason: "The guide's main stats are assigned to other roles. Prioritize pieces with {stat} substats in any slot.",
  ...
  "zh-CN": {
    ...
    comparisonPending: "由于无法计算最终属性，目标比较与强化建议暂时保留。请稍后再试。",
    enkaFinalStatsNote: "这是根据公开的角色、光锥、遗器与已解锁星魂轨迹计算出的战斗外最终数值，不包含战斗中及条件性效果。",
    enkaStatsUnavailable: "由于无法获取静态数据，最终属性的计算与目标比较暂时保留。请稍后再试。",
    mihomoFinalStatsNote: "这是合算公开的角色、光锥、遗器与星魂轨迹得出的战斗外最终数值，不包含战斗中及条件性效果。",
    mihomoStatsUnavailable: "由于无法获取最终属性，目标比较暂时保留。请稍后再试。",
    anySlot: "全部位", anySlotSubstatReason: "指南的主属性已用于其他用途。不限部位，优先筛选带有{stat}副属性的装备。",
